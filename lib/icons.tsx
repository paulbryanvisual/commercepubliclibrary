...
/**
 * Icon library — curated set of SVG icons for CMS use.
 * Each entry is the inner SVG children (paths, circles, etc.)
 * rendered inside a standard 24x24 viewBox.
 */
const ICON_LIBRARY: Record<string, React.ReactNode> = {
  ...
  passport: <><rect x="2" y="3" width="20" height="18" rx="2"/><circle cx="12" cy="11" r="3"/><path d="M7 21v-1a5 5 0 0 1 10 0v1"/></>,
  "id-card": <><rect x="2" y="4" width="20" height="16" rx="2"/><circle cx="8" cy="12" r="2"/><path d="M14 10h4"/><path d="M14 14h4"/></>,

  // Buildings & places
  home: <><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></>,
  building: <><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22V6h6v16"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M8 10h.01"/><path d="M16 10h.01"/><path d="M8 14h.01"/><path d="M16 14h.01"/></>,
  ...
  car: <><path d="M14 16H9m10 0h3v-3.15a1 1 0 0 0-.84-.99L16 11l-2.7-3.6a1 1 0 0 0-.8-.4H5.24a2 2 0 0 0-1.8 1.1l-.8 1.63A6 6 0 0 0 2 12.42V16h3"/><circle cx="6.5" cy="16.5" r="2.5"/><circle cx="16.5" cy="16.5" r="2.5"/></>,
  ...
  baby: <><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/><path d="M9.5 7.5c0-.3.2-.5.5-.5h4c.3 0 .5.2.5.5"/></>,
  graduation: <><path d="M22 10l-10-5L2 10l10 5 10-5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/><line x1="22" y1="10" x2="22" y2="16"/></>,
...
/**
 * CmsIcon — renders an icon from the library by name.
 * Falls back to "book" if the name is unknown.
 */
export function CmsIcon({
  ...
  const children = ICON_LIBRARY[name] || ICON_LIBRARY.book;
  return (
    <svg
      width={size}
      height={size}
